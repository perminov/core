...
--
-- Хост: localhost
-- Время создания: Мар 10 2013 г., 20:46
...
(1, 1, 'Наименование', 'title', 1, 1, '', 1, 0, '', 0, 'e', '', '0', '', ''),
(2, 1, 'Тип столбца MySQL', 'type', 1, 1, '', 2, 0, '', 0, 'e', '', '0', '', ''),
(3, 1, 'Пригоден для хранения внешних ключей', 'canStoreRelation', 10, 5, 'n', 3, 6, '', 0, 'e', '', '0', '', ''),
(4, 2, 'Наименование', 'title', 1, 1, '', 4, 0, '', 0, 'e', '', '0', '', ''),
(5, 2, 'Таблица БД', 'table', 1, 1, '', 5, 0, '', 0, 'e', '', '0', '', ''),
(6, 5, 'Сущность, в структуру которой входит это поле', 'entityId', 3, 3, '0', 6, 2, '', 0, 'e', '', '0', '', ''),
(7, 5, 'Наименование поля', 'title', 1, 1, '', 7, 0, '', 0, 'e', '', '0', '', ''),
(8, 5, 'Наименование соответствующего полю столбца в  таблице БД', 'alias', 1, 1, '', 8, 0, '', 0, 'e', '', '0', '', ''),
(9, 5, 'Тип столбца MySQL', 'columnTypeId', 3, 3, '0', 11, 1, '', 10, 'с', 'one', '0', '', ''),
(10, 5, 'Элемент управления', 'elementId', 3, 3, '0', 10, 4, '', 470, 'с', 'one', '0', '', ''),
(11, 5, 'Значение по умолчанию', 'defaultValue', 1, 1, '', 12, 0, '', 0, 'e', '', '0', '', ''),
(12, 5, 'Ключи какой сущности будут храниться в этом поле', 'relation', 3, 3, '0', 344, 2, '', 0, 'e', '', '0', '', ''),
(14, 5, 'Положение в списке', 'move', 3, 4, '0', 13, 0, '', 0, 'e', '', '0', '', ''),
(15, 6, 'Поле', 'fieldId', 3, 3, '0', 15, 5, '', 0, 'e', '', '0', '', ''),
(16, 6, 'Наименование', 'title', 1, 1, '', 16, 0, '', 0, 'e', '', '0', '', ''),
(17, 6, 'Псевдоним', 'alias', 1, 1, '', 17, 0, '', 0, 'e', '', '0', '', ''),
(18, 3, 'Подчинен разделу', 'sectionId', 3, 3, '0', 19, 3, '', 0, 'e', '', '0', '', ''),
...
(20, 3, 'Наименование', 'title', 1, 1, '', 18, 0, '', 0, 'e', '', '0', '', ''),
(21, 3, 'Контроллер', 'alias', 1, 1, '', 21, 0, '', 0, 'e', '', '0', '', ''),
(22, 3, 'Статус', 'toggle', 10, 5, 'y', 20, 6, '', 0, 'e', '', '0', '', ''),
(23, 3, 'Положение в списке', 'move', 3, 4, '', 310, 0, '', 0, 'e', '', '0', '', ''),
(25, 3, 'Количество строк на странице', 'rowsOnPage', 3, 1, '30', 514, 0, '', 0, 'e', '', '0', '', ''),
(26, 8, 'Раздел, за которым закреплено действие', 'sectionId', 3, 3, '', 1, 3, '', 0, 'e', '', '0', '', ''),
(27, 8, 'Действие', 'actionId', 3, 3, '', 1, 7, '', 0, 'e', '', '0', '', ''),
(28, 8, 'Профили пользователей, имеющих доступ к этому действию в этом разделе', 'profileIds', 1, 7, '1,2,3', 1, 10, '', 0, 'e', '', '0', '', ''),
(29, 8, 'Статус', 'toggle', 10, 5, 'y', 1, 6, '', 0, 'e', '', '0', '', ''),
(30, 8, 'Положение в списке', 'move', 3, 4, '', 1, 0, '', 0, 'e', '', '0', '', ''),
(31, 7, 'Наименование', 'title', 1, 1, '', 26, 0, '', 0, 'e', '', '0', '', ''),
(32, 7, 'Псевдоним', 'alias', 1, 1, '', 27, 0, '', 0, 'e', '', '0', '', ''),
(33, 9, 'Раздел', 'sectionId', 3, 3, '', 28, 3, '', 0, 'e', '', '0', '', ''),
(34, 9, 'Столбец', 'fieldId', 3, 3, '', 29, 5, '', 33, 'с', 'one', 'entityId', '', ''),
(35, 9, 'Очередность отображения столбца в гриде', 'move', 3, 4, '', 30, 0, '', 0, 'e', '', '0', '', ''),
(36, 10, 'Наименование', 'title', 1, 1, '', 31, 0, '', 0, 'e', '', '0', '', ''),
(37, 10, 'Статус', 'toggle', 10, 5, 'y', 32, 6, '', 0, 'e', '', '0', '', ''),
(38, 11, 'Профиль', 'profileId', 3, 3, '', 33, 10, '', 0, 'e', '', '0', '', ''),
(39, 11, 'Фамилия Имя', 'title', 1, 1, '', 34, 0, '', 0, 'e', '', '0', '', ''),
(40, 11, 'Email (используется в качестве логина)', 'email', 1, 1, '', 35, 0, '', 0, 'e', '', '0', '', ''),
(41, 11, 'Пароль', 'password', 1, 1, '', 36, 0, '', 0, 'e', '', '0', '', ''),
(42, 11, 'Статус', 'toggle', 10, 5, 'y', 37, 6, '', 0, 'e', '', '0', '', ''),
(64, 4, 'Наименование', 'title', 1, 1, '', 53, 0, '', 0, 'e', '', '0', '', ''),
(65, 4, 'Псевдоним', 'alias', 1, 1, '', 54, 0, '', 0, 'e', '', '0', '', ''),
...
(92, 4, 'Скрывать при генерации формы', 'hidden', 12, 9, '0', 72, 0, '', 0, 'e', '', '0', '', ''),
(106, 20, 'Поле', 'fieldId', 3, 3, '0', 86, 5, '', 0, 'e', '', '0', '', ''),
(107, 20, 'Наименование', 'title', 1, 1, '', 87, 0, '', 0, 'e', '', '0', '', ''),
(108, 20, 'Псевдоним', 'alias', 1, 1, '', 88, 0, '', 0, 'e', '', '0', '', ''),
(109, 20, 'Ширина', 'masterDimensionValue', 3, 15, '0', 91, 0, '', 0, 'e', '', '0', '', ''),
(110, 20, 'Высота', 'slaveDimensionValue', 3, 15, '0', 93, 0, '', 0, 'e', '', '0', '', ''),
(111, 20, 'Размер', 'proportions', 10, 5, 'o', 89, 6, '', 0, 'e', 'one', '0', '', ''),
(112, 20, 'Ограничить пропорциональную <span id="slaveDimensionTitle">высоту</span>', 'slaveDimensionLimitation', 12, 9, '1', 92, 0, 'if($(''#proportionsP'').attr(''checked'')){if(!this.checked) hide(''tr-slaveDimensionValue''); else show(''tr-slaveDimensionValue'');}', 0, 'e', '', '0', '', ''),
(114, 20, 'При расчете пропорций отталкиваться от', 'masterDimensionAlias', 10, 5, 'width', 90, 6, '$(''#td-left-masterDimensionValue'').text(this.value==''height'' ? ''Высота:'':''Ширина:'');$(''#td-left-slaveDimensionValue'').text(this.value!=''height'' ? ''Высота:'':''Ширина:'');$(''#slaveDimensionTitle'').text(this.value!=''height'' ? ''высоту'':''ширину'');', 0, 'e', '', '0', '', ''),
(115, 6, 'Javascript-сценарий при выборе этого значения', 'javascript', 4, 6, '', 94, 0, '', 0, 'e', '', '0', '', ''),
(116, 5, 'Javascript-сценарий при изменении значения поля', 'javascript', 4, 6, '', 95, 0, '', 0, 'e', '', '0', '', ''),
(131, 25, 'Наименование', 'title', 1, 1, '', 96, 0, '', 0, 'e', '', '0', '', ''),
(133, 25, 'Псевдоним', 'alias', 1, 1, '', 97, 0, '', 0, 'e', '', '0', '', ''),
(134, 25, 'Ключевые слова', 'keywords', 4, 6, '', 102, 0, '', 0, 'e', '', '0', '', ''),
(135, 25, 'Описание', 'description', 4, 6, '', 101, 0, '', 0, 'e', '', '0', '', ''),
(136, 25, 'Контент', 'content', 4, 13, '', 100, 0, '', 0, 'e', '', '0', '', ''),
(137, 25, 'Статус', 'toggle', 10, 5, 'y', 929, 6, '', 0, 'e', '', '0', '', ''),
(345, 7, 'Для выполнения действия необходимо выбрать стоку', 'rowRequired', 10, 5, 'y', 308, 6, '', 0, 'e', '', '0', '', ''),
(346, 7, 'Javascript', 'javascript', 4, 6, '', 309, 0, '', 0, 'e', '', '0', '', ''),
(347, 3, 'Javascript для выполнения после загрузки грида', 'javascript', 4, 6, '', 1278, 0, '', 0, 'e', '', '0', '', ''),
(377, 6, 'Порядок отображения', 'move', 3, 4, '0', 338, 0, '', 0, 'e', '', '0', '', ''),
(383, 5, 'Столбец-satellite', 'satellite', 3, 3, '0', 523, 5, '', 0, 'e', '', '0', '', ''),
(454, 5, 'Динамическое обновление', 'span', 0, 16, '', 428, 0, '', 0, 'e', '', '0', '', ''),
(455, 5, 'Тип зависимости', 'dependency', 10, 5, 'e', 701, 6, '', 0, 'e', '', '0', '', ''),
...
CREATE TABLE IF NOT EXISTS `visitor` (
  ...
  `hidden` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=523949 ;
...
(523948, '', '2013-03-10 20:24:30', 0, 0);
