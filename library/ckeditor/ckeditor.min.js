...
CKEDITOR.config.wsc_customerId=CKEDITOR.config.wsc_customerId||"1:ua3xw1-2XyGJ3-GWruD3-6OFNT1-oXcuB1-nR6Bp4-hgQHc-EcYng3-sdRXG3-NOfFk";CKEDITOR.config.wsc_customLoaderScript=CKEDITOR.config.wsc_customLoaderScript||null;(function(){function h(b,e,c){var i=[],g=[],a;for(a=0;a<b.styleSheets.length;a++){var d=b.styleSheets[a];if(!(d.ownerNode||d.owningElement).getAttribute("data-cke-temp")&&!(d.href&&"chrome://"==d.href.substr(0,9)))try{for(var f=d.cssRules||d.rules,d=0;d<f.length;d++)g.push(f[d].selectorText)}catch(h){}}a=g.join(" ");a=a.replace(/(,|>|\+|~)/g," ");a=a.replace(/\[[^\]]*/g,"");a=a.replace(/#[^\s]*/g,"");a=a.replace(/\:{1,2}[^\s]*/g,"");a=a.replace(/\s+/g," ");a=a.split(" ");b=[];for(g=0;g<a.length;g++)f=
...
/\w+\.\w+/));b.getStylesSet=function(b){if(e)return b(e)};b.fire("stylesSet",{styles:e})})})},null,null,1)}})})();CKEDITOR.plugins.add("syntaxhighlight",{requires:"dialog",init:function(a){a.addCommand("syntaxhighlightDialog",new CKEDITOR.dialogCommand("syntaxhighlightDialog"));a.ui.addButton&&a.ui.addButton("Syntaxhighlight",{label:a.lang.syntaxhighlight.title,command:"syntaxhighlightDialog",toolbar:"insert,98"});a.contextMenu&&(a.addMenuGroup("syntaxhighlightGroup"),a.addMenuItem("syntaxhighlightItem",{label:a.lang.syntaxhighlight.contextTitle,icon:this.path+"icons/syntaxhighlight.png",command:"syntaxhighlightDialog",
group:"syntaxhighlightGroup"}),a.contextMenu.addListener(function(a){if(a.getAscendant("pre",!0))return{syntaxhighlightItem:CKEDITOR.TRISTATE_OFF}}));CKEDITOR.dialog.add("syntaxhighlightDialog",this.path+"dialogs/syntaxhighlight.js")}});(function(){function e(a,b){return a.createFakeParserElement(b,"cke_allMedias","allMedias",!0)}CKEDITOR.plugins.add("allmedias",{requires:"dialog,fakeobjects",onLoad:function(){CKEDITOR.addCss("img.cke_allMedias{background-image: url("+CKEDITOR.getUrl(this.path+"images/placeholder.png")+");background-position: center center;background-repeat: no-repeat;border: 1px solid #a9a9a9;width: 80px;height: 80px;}")},init:function(a){a.addCommand("allMedias",new CKEDITOR.dialogCommand("allMedias"));a.ui.addButton&&
a.ui.addButton("allMedias",{label:a.lang.allMedias.allMedias,command:"allMedias",toolbar:"insert,20"});CKEDITOR.dialog.add("allMedias",this.path+"dialogs/allMedias.js");a.addMenuItems&&(a.addMenuGroup("mediagroup"),a.addMenuItems({mediamenu:{label:a.lang.allMedias.properties,command:"allMedias",group:"mediagroup",icon:this.icons}}));a.on("doubleclick",function(a){var d=a.data.element;if(d.is("img")&&d.data("cke-real-element-type")=="allMedias")a.data.dialog="allMedias"});a.contextMenu&&a.contextMenu.addListener(function(a){if(a&&
a.is("img")&&!a.isReadOnly()&&a.data("cke-real-element-type")=="allMedias")return{mediamenu:CKEDITOR.TRISTATE_OFF}})},afterInit:function(a){var b=a.dataProcessor,d=b&&b.dataFilter;htmlFilter=b&&b.htmlFilter;d&&d.addRules({elements:{"cke:object":function(c){if("allMedias"==c.attributes.mtype)return e(a,c);for(var b=0;b<c.children.length;b++)if("cke:embed"==c.children[b].name){if("allMedias"!=c.children[b].attributes.mtype)break;return e(a,c)}return null},"cke:embed":function(b){return"allMedias"!=
b.attributes.mtype?null:e(a,b)}}},1)}})})();CKEDITOR.tools.extend(CKEDITOR.config,{allMediasEmbedTagOnly:!1,allMediasAddEmbedTag:!0,allMediasConvertOnEdit:!1});CKEDITOR.config.plugins='dialogui,dialog,about,a11yhelp,dialogadvtab,basicstyles,bidi,blockquote,clipboard,button,panelbutton,panel,floatpanel,colorbutton,colordialog,templates,menu,contextmenu,div,resize,toolbar,elementspath,list,indent,enterkey,entities,popup,filebrowser,find,fakeobjects,flash,floatingspace,listblock,richcombo,font,forms,format,htmlwriter,horizontalrule,iframe,wysiwygarea,image,smiley,justify,link,liststyle,magicline,maximize,newpage,pagebreak,pastetext,pastefromword,preview,print,removeformat,save,selectall,showblocks,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc,stylesheetparser,syntaxhighlight,allmedias';CKEDITOR.config.skin='moono';(function() {var icons = ( 'about,0,bold,32,italic,64,strike,96,subscript,128,superscript,160,underline,192,bidiltr,224,bidirtl,256,blockquote,288,copy-rtl,320,copy,352,cut-rtl,384,cut,416,paste-rtl,448,paste,480,bgcolor,512,textcolor,544,templates-rtl,576,templates,608,creatediv,640,bulletedlist-rtl,672,bulletedlist,704,numberedlist-rtl,736,numberedlist,768,indent-rtl,800,indent,832,outdent-rtl,864,outdent,896,find-rtl,928,find,960,replace,992,flash,1024,button,1056,checkbox,1088,form,1120,hiddenfield,1152,imagebutton,1184,radio,1216,select-rtl,1248,select,1280,textarea-rtl,1312,textarea,1344,textfield-rtl,1376,textfield,1408,horizontalrule,1440,iframe,1472,image,1504,smiley,1536,justifyblock,1568,justifycenter,1600,justifyleft,1632,justifyright,1664,anchor-rtl,1696,anchor,1728,link,1760,unlink,1792,maximize,1824,newpage-rtl,1856,newpage,1888,pagebreak-rtl,1920,pagebreak,1952,pastetext-rtl,1984,pastetext,2016,pastefromword-rtl,2048,pastefromword,2080,preview-rtl,2112,preview,2144,print,2176,removeformat,2208,save,2240,selectall,2272,showblocks-rtl,2304,showblocks,2336,source-rtl,2368,source,2400,specialchar,2432,scayt,2464,table,2496,redo-rtl,2528,redo,2560,undo-rtl,2592,undo,2624,spellchecker,2656,syntaxhighlight,2688' ),path = CKEDITOR.getUrl( 'plugins/icons.png' ),icons = icons.split( ',' );for ( var i = 0; i < icons.length; i++ )CKEDITOR.skin.icons[ icons[ i ] ] = { path: path, offset: -icons[ ++i ] };})();CKEDITOR.lang.languages={"en":1,"ru":1};}());