...
class Indi_Auth_Twitter
{
	...
	const URL_ACCOUNT_DATA	= 'https://api.twitter.com/1.1/users/show';
	...
	public function access_token($token, $verifier)
	{
		...
		$_SESSION['user']['oauth_token'] = $result['oauth_token'];
		$_SESSION['user']['oauth_token_secret'] = $result['oauth_token_secret'];
	...
	{
		$consumer_key='c1P35eoEQOdsozH2t4y2A';
		$consumer_secret='HdL9HRA0N55PIxTZUWeltm0kH6Raz7cnTblgjPwbTk';
		$oauth_token = '625637657-AzLZoSywxFquLAYGbdEMdi1NcLRbL8zT9BehjRmr';
		$oauth_token_secret = 'K9Vh6PRW6IGHgQ86gzTKAMmTatkU9sArxOgFxul0eWk';
		$connection = new TwitterOAuth($consumer_key, $consumer_secret, $oauth_token, $oauth_token_secret);
		$query = 'https://api.twitter.com/1.1/users/show.json?screen_name=' . $this->_screen_name;
