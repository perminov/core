...
/** @see Indi_Loader_PluginLoader */
//require_once 'Indi/Loader/PluginLoader.php';

/** @see Indi_View_Interface */
//require_once 'Indi/View/Interface.php';

/**
 * Abstract class for Indi_View to help enforce private constructs.
 *
 * @category   Indi
 * @package    Indi_View
 * @copyright  Copyright (c) 2005-2010 Indi Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Indi_View_Abstract implements Indi_View_Interface
{
    /**
