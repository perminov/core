<?php
class Indi_View_Helper_Admin_FormMultiselect extends Indi_View_Helper_FormElement
{
    public $name = '';
    /**
        ...
        $options = null, $listsep = "<br />\n")
    {
		...
		$attribs['noempty'] = true;

		$options = $options ? $options : $this->view->row->getDropdownData($name, $this->view->trail);
        ...
        if ($disable) {
			...
			$xhtml .= '<input type="hidden" name="' . $this->name . '[-1]" value="">';
