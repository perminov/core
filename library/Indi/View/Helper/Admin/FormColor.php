...
class Indi_View_Helper_Admin_FormColor extends Indi_View_Helper_Abstract
{
    public function formColor($name = 'color', $value = null)
    {
        ...
        $xhtml .= '<iframe id="' . $name . 'Colorpicker" name="' . $name . 'Colorpicker" src="' . $_SERVER['STD'] . ($GLOBALS['cmsOnlyMode'] ? '' : '/admin') . '/auxillary/colorpicker/name/' . $name . '/" frameborder="0" scrolling="no" style="display: inline; width: 218px; height: 190px; position: absolute; top: 1px; left: 73px; z-index: 1; border:1px solid #999999;"></iframe>';
