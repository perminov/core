 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Indi_Session_Namespace extends Indi_Session_Abstract implements IteratorAggregate
{
    ...
    public function __construct($namespace = 'Default', $singleInstance = false)
    {
        if ($namespace === '') {
            ...
            throw new Indi_Session_Exception('Session namespace must be a non-empty string.');
        }
        ...
        if ($namespace[0] == "_") {
             ...
             */
            require_once 'Indi/Session/Exception.php';
            throw new Indi_Session_Exception('Session namespace must not start with an underscore.');
        }
        ...
        if (preg_match('#(^[0-9])#i', $namespace[0])) {
             ...
             */
            require_once 'Indi/Session/Exception.php';
            throw new Indi_Session_Exception('Session namespace must not start with a number.');
        }
        ...
        if (isset(self::$_singleInstances[$namespace])) {
             ...
             */
            require_once 'Indi/Session/Exception.php';
            throw new Indi_Session_Exception("A session namespace object already exists for this namespace ('$namespace'), and no additional accessors (session namespace objects) for this namespace are permitted.");
        }
        ...
        Indi_Session::start(true); // attempt auto-start (throws exception if strict option set)
        ...
        if (self::$_readable === false) {
             ...
             */
            require_once 'Indi/Session/Exception.php';
            throw new Indi_Session_Exception(self::_THROW_NOT_READABLE_MSG);
        }
    ...
    public function & __get($name)
    {
        if ($name === '') {
             ...
             */
            require_once 'Indi/Session/Exception.php';
            throw new Indi_Session_Exception("The '$name' key must be a non-empty string");
        }
    ...
    public function __set($name, $value)
    {
        if (isset(self::$_namespaceLocks[$this->_namespace])) {
             ...
             */
            require_once 'Indi/Session/Exception.php';
            throw new Indi_Session_Exception('This session/namespace has been marked as read-only.');
        }
        ...
        if (parent::$_writable === false) {
             ...
             */
            require_once 'Indi/Session/Exception.php';
            throw new Indi_Session_Exception(parent::_THROW_NOT_WRITABLE_MSG);
        }
    ...
    public function applySet($callback)
    {
        ...
        if (!is_array($result)) {
             ...
             */
            require_once 'Indi/Session/Exception.php';
            throw new Indi_Session_Exception('Result must be an array. Got: ' . gettype($result));
        }
    ...
    public function setExpirationSeconds($seconds, $variables = null)
    {
        ...
        if ($seconds <= 0) {
             ...
             */
            require_once 'Indi/Session/Exception.php';
            throw new Indi_Session_Exception('Seconds must be positive.');
        }
    ...
    public function setExpirationHops($hops, $variables = null, $hopCountOnUsageOnly = false)
    {
        ...
        if ($hops <= 0) {
             ...
             */
            require_once 'Indi/Session/Exception.php';
            throw new Indi_Session_Exception('Hops must be positive number.');
        }
