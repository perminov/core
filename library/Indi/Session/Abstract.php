 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Indi_Session_Abstract
{
    /**
     ...
     * but current Indi_Session has been marked as read-only.
     */
    const _THROW_NOT_WRITABLE_MSG = 'Indi_Session is currently marked as read-only.';


    /**
     * Error message thrown when an action requires reading session data,
     * but current Indi_Session is not marked as readable.
     */
    const _THROW_NOT_READABLE_MSG = 'Indi_Session is not marked as readable.';
    ...
    protected static function _namespaceUnset($namespace, $name = null)
    {
        if (self::$_writable === false) {
             ...
             */
            require_once 'Indi/Session/Exception.php';
            throw new Indi_Session_Exception(self::_THROW_NOT_WRITABLE_MSG);
        }
