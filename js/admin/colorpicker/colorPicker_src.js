...
function colorPicker(e,mode,size,allowResize,allowClose,allowDrag,expColor,expHEX,offsetX,offsetY,orientation,parentObj,parentXY,color,difPad,rSpeed,cookieLife,docBody){
	...
	mode = mode||cP.mode||'H', // ['H', 'S', 'V', 'R', 'G', 'B'] initial colorMode
	size = size||cP.size||2, //[1, 2, 3, 4] initial size from XXS to L
	allowResize = allowResize != undefined?allowResize:cP.allowResize != undefined?cP.allowResize:false, //[true, false] switch to allow/disallow resizing of app
	...
	allowDrag = allowDrag != undefined?allowDrag:cP.allowDrag != undefined?cP.allowDrag:false, //[true, false] switch to allow/disallow dragging app
	expColor = expColor != undefined?expColor:cP.expColor != undefined?cP.expColor:false, //[true, false] switch for exporting colors to background of initial object
	...
	CP=(!cP)?function(obj) { // building the colorPicker / setting up events and methodes
		...
		if (IE) testPix.src=_IE+'_horizontal'; if (!IE || IE8 || testPix.height==1) CSSTxt = CSSTxt.replace(/url\(_[a-z]*\.png\);*/g,"") + '.cPSkinC01,.cPSkinC02,.cPSkinC03,.cPSkinC04{background-image: none !important;}.cPMemory{display: none;}.cPSkinC01,.cPSkinC02,.cPSkinC03,.cPSkinC04,.cPSLCB,.cPSLCW,.cPSRCLB,.cPSRCRB,.cPSRCLW,.cPSRCRW,.cPM0,.cPClose,.cPResize,.cPinpDrag,.cPinpDragOn{background-image:url('+(IE&&!IE8?_IE+'_icons':_nonIE+_icons)+')}.cPSL2R,.cPSL3R,.cPSL2G,.cPSL3G,.cPSL2B,.cPSL3B{background-image:url('+(IE&&!IE8?_IE+'_patches':_nonIE+_patches)+')}.cPSR1R,.cPSR2R,.cPSR3R,.cPSR4R,.cPSR1G,.cPSR2G,.cPSR3G,.cPSR4G,.cPSR1B,.cPSR2B,.cPSR3B,.cPSR4B,.cPSR3H,.cPSR2V,.cPSL3H,.cPSL2S,.cPSR4V,.cPSL3S,.cPSL2V,.cPSR2S{background-image:url('+(IE&&!IE8?_IE+'_vertical':_nonIE+_vertical)+')}.cPSL2H,.cPSL1S,.cPSL1V{background-image:url('+(IE&&!IE8?_IE+'_horizontal':_nonIE+_horizontal)+')}';
