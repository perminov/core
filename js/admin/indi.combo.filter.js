    ...
    var process = function () {
        ...
        indi.proto.combo.filter = function(){
            ...
            this.fetchRelativePath = function() {
                return Indi.pre + '/' + Indi.section + '/form';
            }
            ...
            this.bindTrigger = function(){
                $('.i-combo-keyword').focus(function(){
                ...
                $('.i-combo-trigger').hover(function(){
                    if ($(this).parents('.i-combo').hasClass('i-combo-disabled') ==  false &&
                ...
                $('.i-combo-trigger').mouseup(function(){
                    if ($(this).parents('.i-combo').hasClass('i-combo-disabled') ==  false &&
                        $(this).parents('.i-combo').find('.i-combo-keyword').hasClass('i-combo-keyword-no-results') ==  false) {
                        $(this).parents('table').find('.i-combo-keyword').click();
        ...
        // Enter point
        if ($('.i-combo-filter').length) {
            indi.combo.filter = new indi.proto.combo.filter();
            indi.combo.filter.run();
        }
    };
