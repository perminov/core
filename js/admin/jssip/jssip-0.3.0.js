/*
 * JsSIP version 0.3.0
 * Copyright (c) 2012-2013 JosГ© Luis MillГЎn - Versatica <http://www.versatica.com>
  ...
  for(parameter in settings) {
    switch(parameter) {
      ...
      case 'registrar_server':
        console.log('В· ' + parameter + ': ' + settings[parameter]);
        break;
      default:
        console.log('В· ' + parameter + ': ' + window.JSON.stringify(settings[parameter]));
    }
