...
insert  into `action`(`id`,`title`,`alias`,`toggle`,`rowRequired`,`javascript`,`type`,`display`) values (1,'Список','index','y','y','','s',0),(2,'Детали','form','y','y','Indi.load(Indi.trail().section.href + this.actionAlias + \"/id/\" + row.id + \"/ph/\" + Indi.trail().section.primaryHash + \"/aix/\" + aix + \"/\");','s',1),(3,'Сохранить','save','y','y','Indi.load(Indi.trail().section.href + this.actionAlias + \"/id/\" + row.id + \"/ph/\" + Indi.trail().section.primaryHash + \"/aix/\" + aix + \"/\");','s',0),(4,'Удалить','delete','y','y','var actionAlias = this.actionAlias;\r\nExt.MessageBox.show({\r\n  title:Indi.lang.I_ACTION_DELETE_CONFIRM_TITLE,\r\n  msg: Indi.lang.I_ACTION_DELETE_CONFIRM_MSG,\r\n  buttons: Ext.MessageBox.YESNO,\r\n  icon: Ext.MessageBox.QUESTION,\r\n  fn: function(answer, arg2){\r\n     if (answer == \"yes\") {\r\n        Indi.load(Indi.trail().section.href + actionAlias+\"/id/\"+row.id + \"/ph/\" + Indi.trail().section.primaryHash + \"/aix/\" + aix + \"/\");\r\n     }\r\n  }\r\n});','s',1),(5,'Выше','up','y','y','Indi.load(Indi.trail().section.href + this.actionAlias + \"/id/\" + row.id + \"/ph/\" + Indi.trail().section.primaryHash + \"/aix/\" + aix + \"/\");','s',1),(6,'Ниже','down','y','y','Indi.load(Indi.trail().section.href + this.actionAlias + \"/id/\" + row.id + \"/ph/\" + Indi.trail().section.primaryHash + \"/aix/\" + aix + \"/\");','s',1),(7,'Статус','toggle','y','y','Indi.load(Indi.trail().section.href + this.actionAlias + \"/id/\" + row.id + \"/ph/\" + Indi.trail().section.primaryHash + \"/aix/\" + aix + \"/\");','s',1),(18,'Обновить кэш','cache','y','y','Indi.load(Indi.trail().section.href + this.actionAlias + \"/id/\" + row.id + \"/ph/\" + Indi.trail().section.primaryHash + \"/aix/\" + aix + \"/\");','s',1),(19,'Обновить sitemap.xml','sitemap','y','n','$.post(\'/sitemap/index/update\',function(response){\r\n  Ext.MessageBox.show({\r\n    title: \'Сообщение\',\r\n    msg: response,\r\n    buttons: Ext.MessageBox.OK,\r\n    icon: Ext.MessageBox.INFO\r\n  });\r\n});\r\nreturn false;','s',1),(20,'Авторизация','login','y','y','Indi.load(Indi.trail().section.href + this.actionAlias + \"/id/\" + row.id + \"/ph/\" + Indi.trail().section.primaryHash + \"/aix/\" + aix + \"/\");','o',1);
...
insert  into `profile`(`id`,`title`,`toggle`,`entityId`,`home`,`move`) values (1,'Конфигуратор','y',0,'',1),(12,'Администратор','y',0,'',12),(17,'Ползователь','y',130,'',17);
...
insert  into `search`(`id`,`sectionId`,`fieldId`,`move`,`toggle`,`alt`,`title`,`defaultValue`,`filter`,`ignoreTemplate`) values (13,5,612,13,'y','','Тип','','',1),(54,146,691,55,'y','','Дата регистрации','','',1),(55,146,689,56,'y','','Пол','','',1),(114,5,1441,114,'y','','Включить в кэш','','',1);
