...
insert  into `action`(`id`,`title`,`alias`,`toggle`,`rowRequired`,`javascript`,`type`,`display`) values (1,'Список','index','y','y','','s',0),(2,'Детали','form','y','y','loadContent(grid.indi.href + this.actionAlias + \"/id/\" + row.id + \"/\");','s',1),(3,'Сохранить','save','y','y','loadContent(grid.indi.href + this.actionAlias + \"/id/\" + row.id + \"/\");','s',0),(4,'Удалить','delete','y','y','var actionAlias = this.actionAlias;\r\nExt.MessageBox.show({\r\n  title:grid.indi.msgbox.confirm.title,\r\n  msg: grid.indi.msgbox.confirm.message,\r\n  buttons: Ext.MessageBox.YESNO,\r\n  icon: Ext.MessageBox.QUESTION,\r\n  fn: function(answer, arg2){\r\n     if (answer == \"yes\") {\r\n        loadContent(grid.indi.href + actionAlias+\"/id/\"+row.id + \"/\");\r\n     }\r\n  }\r\n});','s',1),(5,'Выше','up','y','y','loadContent(grid.indi.href + this.actionAlias + \"/id/\" + row.id + \"/\");','s',1),(6,'Ниже','down','y','y','loadContent(grid.indi.href + this.actionAlias + \"/id/\" + row.id + \"/\");','s',1),(7,'Статус','toggle','y','y','loadContent(grid.indi.href + this.actionAlias + \"/id/\" + row.id + \"/\");','s',1),(18,'Обновить кэш','cache','y','y','loadContent(grid.indi.href + this.actionAlias + \"/id/\" + row.id + \"/\");','s',1),(19,'Обновить sitemap.xml','sitemap','y','n','$.post(\'/sitemap/index/update\',function(response){\r\n  Ext.MessageBox.show({\r\n    title: \'Сообщение\',\r\n    msg: response,\r\n    buttons: Ext.MessageBox.OK,\r\n    icon: Ext.MessageBox.INFO\r\n  });\r\n});\r\nreturn false;','s',1),(20,'Авторизация','login','y','y','loadContent(grid.indi.href + this.actionAlias + \"/id/\" + row.id + \"/\");','o',1);
...
insert  into `disabledfield`(`id`,`sectionId`,`fieldId`,`defaultValue`) values (87,146,1028,''),(84,146,961,''),(35,146,685,''),(85,146,962,''),(86,146,699,''),(43,146,1108,''),(94,146,1577,''),(93,146,1576,''),(92,146,1575,''),(91,146,1162,''),(90,146,1163,''),(89,146,1161,''),(88,146,698,'');
...
insert  into `grid`(`id`,`sectionId`,`fieldId`,`move`,`alterTitle`,`toggle`) values (1,2,1,1,'','y'),(2,2,2,2,'','y'),(3,2,3,3,'','y'),(4,5,4,4,'','y'),(5,5,5,5,'','y'),(6,6,7,6,'','y'),(7,6,8,7,'','y'),(8,6,9,8,'','y'),(9,6,10,9,'','y'),(10,6,11,10,'','y'),(11,6,12,11,'','y'),(13,6,14,13,'','y'),(14,7,19,16,'Сущность','y'),(15,7,20,14,'','y'),(16,7,21,15,'','y'),(17,7,22,17,'','y'),(18,7,23,18,'','y'),(20,7,25,926,'','y'),(23,8,27,23,'','y'),(24,8,29,24,'','y'),(25,8,30,25,'','y'),(26,10,31,26,'','y'),(27,10,32,27,'','y'),(29,11,34,29,'','y'),(30,11,35,1156,'','y'),(32,13,36,32,'','y'),(33,13,37,33,'','y'),(34,12,16,34,'','y'),(35,12,17,35,'','y'),(36,14,39,36,'','y'),(37,14,40,37,'','y'),(38,14,41,38,'','y'),(39,14,42,39,'','y'),(42,16,65,43,'','y'),(43,16,66,44,'','y'),(46,16,64,42,'','y'),(89,22,107,56,'','y'),(90,22,108,57,'','y'),(91,22,109,59,'','y'),(92,22,110,60,'','y'),(93,22,111,58,'','y'),(94,22,112,61,'','y'),(130,30,131,61,'','y'),(132,30,133,63,'','y'),(1442,235,1523,983,'','y'),(136,30,137,67,'','y'),(341,12,377,253,'','y'),(375,100,472,289,'','y'),(376,100,473,290,'','y'),(377,100,474,291,'','y'),(378,101,477,292,'','y'),(379,101,478,293,'','y'),(383,8,28,297,'','y'),(1335,7,1366,31,'','y'),(1334,113,1040,925,'','y'),(1333,172,1365,924,'','y'),(1332,10,1364,923,'','y'),(420,113,559,328,'','y'),(421,113,560,329,'','y'),(422,114,561,329,'','y'),(1097,194,1259,808,'','y'),(424,113,563,330,'','y'),(425,115,565,334,'','y'),(426,115,567,760,'','y'),(427,115,568,332,'','y'),(428,115,569,333,'','y'),(429,116,571,338,'','y'),(430,116,572,795,'','y'),(431,116,573,336,'','y'),(433,119,582,339,'','y'),(434,119,583,340,'','y'),(435,119,584,341,'','y'),(440,122,597,345,'','y'),(441,122,598,344,'','y'),(442,123,603,750,'','y'),(443,5,612,347,'','y'),(489,144,678,388,'','y'),(490,144,679,389,'','y'),(491,144,681,391,'','y'),(492,145,682,391,'','y'),(493,145,683,392,'','y'),(494,146,684,990,'','y'),(1470,146,685,392,'','y'),(1382,224,1444,929,'','y'),(1384,224,1445,928,'','y'),(1325,182,1357,707,'','y'),(1086,193,1247,798,'','y'),(832,172,857,624,'','y'),(833,172,858,625,'','y'),(834,173,860,626,'','y'),(913,182,983,706,'','y'),(914,182,984,708,'','y'),(915,182,985,709,'','y'),(916,182,986,730,'','y'),(917,182,987,922,'','y'),(920,183,996,712,'','y'),(931,122,998,722,'','y'),(930,183,997,721,'','y'),(928,185,1021,719,'','y'),(929,185,1022,720,'','y'),(1383,224,1443,926,'','y'),(1053,189,1102,772,'','y'),(1052,189,1101,771,'','y'),(1051,189,1100,770,'','y'),(1046,188,1088,766,'','y'),(1045,188,1087,764,'','y'),(1044,188,1086,763,'','y'),(1043,188,1085,765,'','y'),(1040,115,1075,335,'','y'),(1039,172,1074,759,'','y'),(1037,123,1000,757,'','y'),(1036,123,1071,751,'','y'),(1035,123,1016,756,'','y'),(1034,123,1015,755,'','y'),(1061,190,1153,778,'','y'),(979,173,1027,728,'','y'),(978,182,991,705,'','y'),(1033,123,1014,754,'','y'),(1032,123,1013,753,'','y'),(1031,123,940,752,'','y'),(1030,123,607,749,'','y'),(1029,123,606,346,'','y'),(1024,119,1044,744,'','y'),(1062,190,1154,779,'','y'),(1064,190,1156,780,'','y'),(1066,191,1194,782,'','y'),(1067,191,1195,783,'','y'),(1068,191,1196,784,'','y'),(1084,116,1244,794,'','y'),(1083,116,1243,337,'','y'),(1087,193,1248,797,'','y'),(1088,193,1249,800,'','y'),(1089,193,1250,801,'','y'),(1090,193,1251,802,'','y'),(1091,193,1252,803,'','y'),(1092,193,1253,804,'','y'),(1093,193,1254,805,'','y'),(1094,193,1255,806,'','y'),(1095,193,1256,836,'','y'),(1098,194,1260,809,'','y'),(1099,194,1261,811,'','y'),(1100,194,1262,812,'','y'),(1101,194,1263,813,'','y'),(1102,194,1264,814,'','y'),(1103,194,1265,815,'','y'),(1104,194,1266,816,'','y'),(1105,194,1267,817,'','y'),(1106,194,1268,837,'','y'),(1108,195,1271,819,'','y'),(1109,195,1272,820,'','y'),(1110,195,1273,822,'','y'),(1111,195,1274,823,'','y'),(1112,195,1275,824,'','y'),(1113,195,1276,825,'','y'),(1114,195,1277,826,'','y'),(1115,195,1278,827,'','y'),(1116,195,1279,828,'','y'),(1117,195,1280,838,'','y'),(1125,193,1317,799,'','y'),(1126,194,1322,810,'','y'),(1127,195,1324,821,'','y'),(1178,198,1331,845,'','y'),(1231,201,1342,851,'','y'),(1444,235,1525,984,'','y'),(1439,232,1515,965,'','y'),(1445,235,1528,985,'','y'),(1443,235,1524,982,'','y'),(1421,232,1485,962,'','y'),(1422,232,1486,963,'','y'),(1423,232,1488,1132,'','y'),(1449,113,1533,989,'','y'),(1448,201,1532,988,'','y'),(1515,113,585,1036,'','y'),(1656,11,1886,30,'','y'),(1767,146,691,1222,'','y'),(1954,224,1658,1945,'','y');
...
CREATE TABLE `visitor` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=555194 DEFAULT CHARSET=utf8;

/*Data for the table `visitor` */

insert  into `visitor`(`id`,`title`,`lastActivity`,`userId`) values (555193,'m6loj1tq3mos5qtrvq3qlcd3n4','2013-10-26 04:07:36',0);
