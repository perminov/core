...
UPDATE `field` SET `storeRelationAbility` = 'one' WHERE `storeRelationAbility` = '' AND `alias` IN  ("canStoreRelation","toggle","masterDimensionAlias","rowRequired","dependency","profileId","proportions");
